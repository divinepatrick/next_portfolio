    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center  justify-center gap-4'>
            ...
            <motion.h3
                ...
                className='flex items-end gap-2 text-xl md:ttext-2xl mb-3 font-Ovo'>
                Hi! I'm Divine Patrick <Image src={assets.hand_icon} alt=''
            ...
            <motion.h1
                ...
                fullstack web developer based in Nigeria.
            </motion.h1>
