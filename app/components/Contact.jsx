    ...
    <motion.div
      ...
      <motion.form
        ...
        <motion.textarea
          ...
          rows="6" placeholder="Enter your message" required className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90' name='mess'></motion.textarea>
